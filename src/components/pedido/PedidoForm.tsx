      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input id="clientCep" name="clientCep" type="tel" value={data.clientCep} onChange={handleInputChange} onBlur={handleCepBlur} placeholder="Ex: 09251-040" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
          </div>
          ...
          <div>
            ...
            <input id="clientPhone" name="clientPhone" type="tel" value={data.clientPhone} onChange={handleInputChange} placeholder="(11) 2036-0010" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
          </div>
          ...
          {clientType === 'pf' ? (
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input id="clientCpf" name="clientCpf" type="tel" value={data.clientCpf} onChange={handleInputChange} placeholder="000.000.000-00" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
              </div>
              <div>
                <label htmlFor="clientRg" className="block text-sm font-medium text-gray-700 mb-1">RG</label>
                <input id="clientRg" name="clientRg" type="text" value={data.clientRg} onChange={handleInputChange} placeholder="00.000.000-0" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input id="clientCnpj" name="clientCnpj" type="tel" value={data.clientCnpj} onChange={handleInputChange} placeholder="00.000.000/0000-00" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
              </div>
              <div>
                <label htmlFor="clientIe" className="block text-sm font-medium text-gray-700 mb-1">Inscrição Estadual</label>
                <input id="clientIe" name="clientIe" type="text" value={data.clientIe} onChange={handleInputChange} placeholder="000.000.000.000" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
              </div>
            </div>
          )}
        </div>
            ...
            <div>
              ...
              {(() => {
                ...
                if (cores.length > 0) {
                  ...
                  // Lona → campo livre
                  return <input type="text" value={product.cor_material} onChange={(e) => updateProductField(index, 'cor_material', e.target.value)} placeholder="Cor à escolha do cliente" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
                }
                return <input type="text" value={product.cor_material} onChange={(e) => updateProductField(index, 'cor_material', e.target.value)} placeholder="Cor do material" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
              })()}
            </div>
            <div>
                      ...
                      <div className="grid gap-2" style={{ gridTemplateColumns: `repeat(${cols}, 1fr)` }}>
                        {showComp && (
                          <div>
                            ...
                            <input type="text" value={m.comprimento} onChange={(e) => updateMeasureField(index, mi, 'comprimento', e.target.value)} placeholder="5,60" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
                          </div>
                        )}
                        {showLarg && (
                          <div>
                            <label className="block text-xs text-gray-500 mb-0.5">Largura (m)</label>
                            <input type="text" value={m.largura} onChange={(e) => updateMeasureField(index, mi, 'largura', e.target.value)} placeholder="1,40" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
                          </div>
                        )}
                        {showAlt && (
                          <div>
                            ...
                            <div className="flex gap-1">
                              <input type="text" value={m.altura} onChange={(e) => updateMeasureField(index, mi, 'altura', e.target.value)} placeholder="0,30" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
                              {mi > 0 && (
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input id="productValue" name="productValue" type="tel" value={data.productValue} onChange={handleInputChange} placeholder="Ex: 2000,00" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
          </div>
          <div>
          ...
          {/* Múltiplas formas de pagamento — apenas orçamento */}
          {mode === 'orcamento' && (
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Opções de Pagamento para o Cliente</label>
              <p className="text-xs text-gray-500 mb-2">Adicione várias formas para o cliente escolher.</p>
              {(data.paymentOptions || []).map((opt, oi) => (
                <div key={opt.id} className="flex items-center gap-2 mb-2">
                  <input
                    ...
                    value={opt.label}
                    onChange={(e) => {
                      const updated = [...(data.paymentOptions || [])]
                      updated[oi] = { ...updated[oi], label: e.target.value }
                      onChange({ ...data, paymentOptions: updated })
                    }}
                    placeholder={`Opção ${oi + 1}: ex: À vista com 10% de desconto`}
                    className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-md"
                  />
                  <button type="button" onClick={() => {
                    const updated = (data.paymentOptions || []).filter((_, i) => i !== oi)
                    onChange({ ...data, paymentOptions: updated })
                  }} className="text-red-400 hover:text-red-600 p-1">✕</button>
                </div>
              ))}
              <button type="button" onClick={() => {
                const updated = [...(data.paymentOptions || []), { id: crypto.randomUUID ? crypto.randomUUID().slice(0, 8) : Date.now().toString(), label: '' }]
                onChange({ ...data, paymentOptions: updated })
          ...
          <div>
            ...
            {deliveryTimeType === 'days' && (
              <div className="mt-2">
                ...
                <input id="deliveryTime" name="deliveryTime" type="number" value={data.deliveryTime.replace(/\s*dias/i, '')} onChange={handleInputChange} placeholder="Ex: 20" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm" inputMode="decimal" />
